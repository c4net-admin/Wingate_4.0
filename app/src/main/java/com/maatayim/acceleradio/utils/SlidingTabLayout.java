...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private static final float TAB_VIEW_TEXT_SIZE_SP = 15F;
	private static final String TAG = "200apps.SlidingTabLayout";
	...
	public void setTextColors(int selectedColor, int unselectedColor){
	...
	protected View createDefaultTabView(Context context) {
    	Log.d(TAG,"createDefaultTabView");
        TextView textView = new TextView(context);
        textView.setGravity(Gravity.CENTER);
        
        float textSizeSp = this.textSizeSp != 0?
        		this.textSizeSp :
